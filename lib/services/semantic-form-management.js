...
export class SemanticFormManagement {
  ...
  /**
   * Returns a collection off the latest sources to be used by the forms.
   *
   * @returns {(SemanticFile)[]}
   */
  getLatestSources() {
    return [
      this.config_files.specification.turtle,
      this.config_files.specification.json,
      this.meta_files.latest,
    ];
  }
