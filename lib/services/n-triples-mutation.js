...
import { MUTATION_QUERY_CHUNK_SIZE } from '../../env';
 ...
 * {@see MUTATION_QUERY_CHUNK_SIZE}
 *
 * @param statements
 * @param chunk
 * @returns {[]}
 */
function chunkStatements(statements, chunk = MUTATION_QUERY_CHUNK_SIZE) {
  let chunks = [];
