...
import { MetaDataGenerationService } from './meta-gen-service';

const PUBLISHER = `${APP_URI}/meta-sync-service`;

export class MetaDataService extends FileSyncService {

  constructor(configSyncService) {
    super(PUBLISHER, META_DATA_ROOT);
    this.meta = new MetaDataGenerationService(configSyncService);
