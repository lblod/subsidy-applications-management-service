    ...
    if (!this.started) {
      ...
      if (!this.job) {
        ...
        this.job.addCallback(async () => {
          // TODO export amount of days to env.
          if (this.triggered.diff(moment(), 'days') >= 5) {
            console.log(`Global meta-data update for ${this.root} STOPPED, Reason: stale meta-data, hasn't been triggered withing 5 days.`);
