...
export class SemanticFile {
  ...
  toNT() {
    ...
    const escaped = {
      virtualURI: `<${this.virtualURI}>`, // TODO redo with proper escape
      physicalURI: `<${this.physicalURI}>`, // TODO redo with proper escape
      ...
      publisher: `<${this.publisher}>`, // TODO redo with proper escape
    };
