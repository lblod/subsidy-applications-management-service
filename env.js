...
const VERSIONED_CONFIGURATION_WATCHER_DISABLED = process.env.VERSIONED_CONFIGURATION_WATCHER_DISABLED == 'true';
console.log(`File watcher will be disabled? ${VERSIONED_CONFIGURATION_WATCHER_DISABLED}`);
